...
|---|---|---|---|
| [`scripts/dev/`](./dev/README.md) | **本地开发与测试**：一键启动 Agent + BFF + 前端 HMR、中台微服务联动、E2E 自动化测试 | `dev-start-go.sh`<br/>`run_console_e2e_tests.sh`<br/>`dev-stop.sh` | [查看 Dev 文档](./dev/README.md) |
