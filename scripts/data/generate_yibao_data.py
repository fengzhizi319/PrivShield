...
Usage:
    ...
    python scripts/data/generate_yibao_data.py --output privacy_local_agent/medical_pipeline/samples/yibao.csv --count 50
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        default="privacy_local_agent/medical_pipeline/samples/yibao.csv",
        help="输出 CSV 文件路径",
    )
    ...
    console_backend_path = Path("console/backend/samples/yibao.csv")
    ...
    console_go_path = Path("console/backend-go/internal/samples/yibao.csv")
