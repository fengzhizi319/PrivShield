...
Usage:
    ...
    python scripts/data/generate_yibao_data.py --output PrivShield/medical_pipeline/samples/yibao.csv --count 50
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        default="PrivShield/medical_pipeline/samples/yibao.csv",
        help="输出 CSV 文件路径",
    )
