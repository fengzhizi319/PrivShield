...
- [1. 算法设计原理](#1-算法设计原理)
  - [1.1 差分隐私定义](#11-差分隐私定义)
  - [1.2 敏感度](#12-敏感度)
  - [1.3 Laplace 机制](#13-laplace-机制)
  - [1.4 Gaussian 机制](#14-gaussian-机制)
  - [1.5 mean 组合实现与组合定理](#15-mean-组合实现与组合定理)
  - [1.6 本地差分隐私（Local DP）](#16-本地差分隐私local-dp)
  - [1.7 模块设计概览](#17-模块设计概览)
- [2. Python SDK](#2-python-sdk)
  - [2.1 `DPApi`](#21-dpapi)
  - [2.2 `extract_values`（数据适配器）](#22-extract_values数据适配器)
  - [2.3 `LocalDPApi`](#23-localdpapi)
  - [2.4 `BudgetAccountant` & `BudgetRegistry`](#24-budgetaccountant-budgetregistry)
  - [2.5 数据表 / CSV 场景下的正确使用方式](#25-数据表-csv-场景下的正确使用方式)
- [3. REST API](#3-rest-api)
  - [POST `/v1/privacy/dp/count`](#post-v1privacydpcount)
  - [POST `/v1/privacy/dp/sum`](#post-v1privacydpsum)
  - [POST `/v1/privacy/dp/mean`](#post-v1privacydpmean)
  - [POST `/v1/privacy/dp/histogram`](#post-v1privacydphistogram)
  - [POST `/v1/privacy/dp/noisy_count`](#post-v1privacydpnoisy_count)
  - [POST `/v1/privacy/dp/noisy_sum`](#post-v1privacydpnoisy_sum)
  - [POST `/v1/privacy/dp/noisy_mean`](#post-v1privacydpnoisy_mean)
  - [POST `/v1/privacy/dp/noisy_histogram`](#post-v1privacydpnoisy_histogram)
  - [POST `/v1/privacy/dp/chunked_count`](#post-v1privacydpchunked_count)
  - [POST `/v1/privacy/dp/chunked_sum`](#post-v1privacydpchunked_sum)
  - [POST `/v1/privacy/dp/chunked_mean`](#post-v1privacydpchunked_mean)
  - [POST `/v1/privacy/dp/chunked_histogram`](#post-v1privacydpchunked_histogram)
  - [POST `/v1/privacy/ldp/perturb/binary`](#post-v1privacyldpperturbbinary)
  - [POST `/v1/privacy/ldp/perturb/categorical`](#post-v1privacyldpperturbcategorical)
  - [POST `/v1/privacy/ldp/estimate/binary`](#post-v1privacyldpestimatebinary)
  - [POST `/v1/privacy/ldp/estimate/categorical`](#post-v1privacyldpestimatecategorical)
- [4. gRPC API](#4-grpc-api)
  - [方法列表](#方法列表)
  - [`DPRequest` 字段](#dprequest-字段)
  - [`DPResponse` 字段](#dpresponse-字段)
  - [`DPHistogramRequest` 字段](#dphistogramrequest-字段)
  - [`DPHistogramResponse` 字段](#dphistogramresponse-字段)
  - [Noisify 相关 Message 字段](#noisify-相关-message-字段)
  - [Chunked 相关 Message 字段](#chunked-相关-message-字段)
  - [LDP 相关 Message 字段](#ldp-相关-message-字段)
- [5. 异常与错误码](#5-异常与错误码)
- [6. 使用场景与参数建议](#6-使用场景与参数建议)
  - [6.1 典型应用场景](#61-典型应用场景)
  - [6.2 参数选择指南](#62-参数选择指南)
  - [6.3 性能优化建议](#63-性能优化建议)
  - [6.4 安全注意事项](#64-安全注意事项)
  - [6.5 故障排查速查表](#65-故障排查速查表)
  - [6.6 与其他隐私技术的对比](#66-与其他隐私技术的对比)
- [7. 最佳实践总结](#7-最佳实践总结)
- [8. 高级特性 API](#8-高级特性-api)
  - [8.1 `adaptive_clip`](#81-adaptive_clip)
  - [8.2 `dp_aggregate`](#82-dp_aggregate)
  - [8.3 `vector_sum` / `vector_mean`](#83-vector_sum-vector_mean)
  - [8.4 `dp_groupby`](#84-dp_groupby)
  - [8.5 `Accumulator` 分布式累加器](#85-accumulator-分布式累加器)
  - [8.6 `RDPAccountant`](#86-rdpaccountant)
