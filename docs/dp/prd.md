...
- [3. 功能需求](#3-功能需求)
- [4. 接口定义](#4-接口定义)
  - [4.1 REST 请求示例](#41-rest-请求示例)
  - [4.2 Noisify 接口示例](#42-noisify-接口示例)
  - [4.3 Chunked 接口示例](#43-chunked-接口示例)
  - [4.4 gRPC 字段](#44-grpc-字段)
- [5. 隐私预算设定指南](#5-隐私预算设定指南)
  - [5.1 ε 取值参考](#51-ε-取值参考)
  - [5.2 δ 取值参考](#52-δ-取值参考)
  - [5.3 预算分配建议](#53-预算分配建议)
- [6. 验收标准](#6-验收标准)
