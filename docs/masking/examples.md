...
- [1. Python SDK 示例](#1-python-sdk-示例)
  - [1.1 单字段脱敏](#11-单字段脱敏)
  - [1.2 整记录脱敏](#12-整记录脱敏)
  - [1.3 批量字段脱敏](#13-批量字段脱敏)
  - [1.4 DataFrame 脱敏](#14-dataframe-脱敏)
  - [1.5 多格式输入示例](#15-多格式输入示例)
  - [1.6 HMAC 哈希与截断](#16-hmac-哈希与截断)
- [2. REST API 示例](#2-rest-api-示例)
- [3. 最佳实践](#3-最佳实践)
...
```python
from engine.privacy.masking import mask_value_batch
...
```python
from engine.privacy.masking import hash_value, truncate
