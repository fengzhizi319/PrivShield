...
- [2. 产品设计目标](#2-产品设计目标)
- [3. 功能需求矩阵](#3-功能需求矩阵)
  - [3.1 Layer-1 声明式规则引擎](#31-layer-1-声明式规则引擎)
  - [3.2 Layer-2/3 三层漏斗与智能分类](#32-layer-23-三层漏斗与智能分类)
  - [3.3 图像打码与安全治理](#33-图像打码与安全治理)
  - [3.4 运维与可观测性](#34-运维与可观测性)
- [4. 接口契约与验收标准](#4-接口契约与验收标准)
  - [4.1 REST / HTTP 接口验收标准](#41-rest--http-接口验收标准)
  - [4.2 性能与稳定性验收标准](#42-性能与稳定性验收标准)
