...
- [1. 裁决总览](#1-裁决总览)
- [2. LLM 直接裁定（最高优先级）](#2-llm-直接裁定最高优先级)
  - [2.1 触发场景](#21-触发场景)
  - [2.2 裁定规则](#22-裁定规则)
  - [2.3 设计意图与一致性保障](#23-设计意图与一致性保障)
- [3. 标签过滤裁决（无 LLM 裁定时）](#3-标签过滤裁决无-llm-裁定时)
  - [3.1 过滤流程](#31-过滤流程)
  - [3.2 Step 1：置信度过滤](#32-step-1置信度过滤)
  - [3.3 Step 2：降级标签条件排除](#33-step-2降级标签条件排除)
- [4. engine_layer 归属规则](#4-engine_layer-归属规则)
- [5. 冲突场景完整决策树](#5-冲突场景完整决策树)
- [6. 配置参数参考](#6-配置参数参考)
  - [YAML 配置示例](#yaml-配置示例)
- [7. 边界情况处理](#7-边界情况处理)
- [8. 源码位置](#8-源码位置)
