...
> **标准算法规范**: [`redaction_algorithm_specification.md`](file:///home/charles/code/sfwork/privacy-local-agent/docs/medical_pipeline/redaction_algorithm_specification.md)  
...
├── rules.py             # 医疗专属分级规则、PII 别名与 L4/L5 关键词字典
├── samples/
