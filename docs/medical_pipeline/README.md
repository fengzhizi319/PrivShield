...
1. **高仿真数据生成 (`scripts/generate_medical_data.py`)**: 支持 GB 11643-1999 校验码算法的 18 位身份证、图文病历引用及 L4/L5 级重症/传染病/精神障碍病史数据生成。
...
3. **运行数据生成**: 执行 `python scripts/generate_medical_data.py --output data/data1.csv` 生成 20 条模拟数据。
