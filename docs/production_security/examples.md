...
- [3. REST 调用示例](#3-rest-调用示例)
  ...
  - [3.3 Python 客户端（httpx）](#33-python-客户端httpx)
  - [3.4 mTLS Python 客户端（httpx）](#34-mtls-python-客户端httpx)
- [4. gRPC 调用示例](#4-grpc-调用示例)
  - [4.1 仅服务端 TLS](#41-仅服务端-tls)
  - [4.2 mTLS + 内部 API Key](#42-mtls-内部-api-key)
- [5. 速率限制配置示例](#5-速率限制配置示例)
  - [5.1 默认限速](#51-默认限速)
  - [5.2 按接口覆盖](#52-按接口覆盖)
  - [5.3 多副本 Redis 限速](#53-多副本-redis-限速)
- [6. 健康检查](#6-健康检查)
- [7. 权限最小化实践](#7-权限最小化实践)
