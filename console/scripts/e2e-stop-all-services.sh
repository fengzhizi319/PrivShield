...
echo "⚠️  [DEPRECATED] console/scripts/e2e-stop-all-services.sh has moved to scripts/dev/e2e-stop-all-services.sh" >&2
echo "⚠️  Please update your shortcuts or CI scripts accordingly." >&2

exec bash "$PROJECT_ROOT/scripts/dev/e2e-stop-all-services.sh" "$@"
