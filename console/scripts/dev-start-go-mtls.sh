...
echo "⚠️  [DEPRECATED] console/scripts/dev-start-go-mtls.sh has moved to scripts/dev/dev-start-go-mtls.sh" >&2
echo "⚠️  Please update your shortcuts or CI scripts accordingly." >&2

exec bash "$PROJECT_ROOT/scripts/dev/dev-start-go-mtls.sh" "$@"
