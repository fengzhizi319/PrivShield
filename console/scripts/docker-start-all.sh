...
echo "⚠️  [DEPRECATED] console/scripts/docker-start-all.sh has moved to scripts/dev/docker-start-all.sh" >&2
echo "⚠️  Please update your shortcuts or CI scripts accordingly." >&2

exec bash "$PROJECT_ROOT/scripts/dev/docker-start-all.sh" "$@"
