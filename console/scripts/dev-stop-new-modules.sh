...
echo "⚠️  [DEPRECATED] console/scripts/dev-stop-new-modules.sh has moved to scripts/dev/dev-stop-new-modules.sh" >&2
echo "⚠️  Please update your shortcuts or CI scripts accordingly." >&2

exec bash "$PROJECT_ROOT/scripts/dev/dev-stop-new-modules.sh" "$@"
