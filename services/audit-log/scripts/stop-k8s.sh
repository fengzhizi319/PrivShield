#!/usr/bin/env bash
# ============================================================================
# Audit Log (脱敏审计日志) Kubernetes Standalone Cleanup Script
# 脱敏审计日志服务独立 Kubernetes 资源卸载与停止脚本
#
# 用法 / Usage:
...
echo "============================================================================"
echo "🛑 正在卸载 audit-log Kubernetes 资源 (Namespace: $NAMESPACE)..."
echo "============================================================================"
...
echo "✅ audit-log Kubernetes 资源已成功删除。"
echo "============================================================================"
