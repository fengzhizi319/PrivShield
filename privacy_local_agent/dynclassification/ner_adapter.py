...
class NerAdapter:
    ...
    def _lazy_init(self) -> None:
        ...
        try:
            from ..privacy.classification.classification_ner import ONNXSmallNerEngine
        ...
        # 尝试 2: ModelScope 引擎
        try:
            from ..privacy.classification.classification_ner import ModelScopeSmallNerEngine
